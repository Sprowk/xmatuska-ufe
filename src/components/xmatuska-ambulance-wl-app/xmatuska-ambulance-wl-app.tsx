...
@Component({
  tag: 'xmatuska-ambulance-wl-app',
  styleUrl: 'xmatuska-ambulance-wl-app.css',
  shadow: true,
})

export class XmatuskaAmbulanceWlApp {
  ...
  render() {
    console.debug("xmatuska-ambulance-wl-app.render() - path: %s", this.relativePath);
    let element = "list"
    let entryId = "@new"
